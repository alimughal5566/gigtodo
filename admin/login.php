        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo pb-4">
                    <a href="login.php">
                        <h2 class="text-white"> <?= $site_name; ?> <span
                                    class="badge badge-success p-2 font-weight-bold">ADMIN</span></h2>
                    </a>
                </div>
                    ...
                    <form action="" id="myform" method="post" autocomplete="off">
                        ...
                        <div class="checkbox pb-2">
                            ...
                            <label>
                                ...
                                <input type="checkbox" <?php if (isset($_SESSION["r_email"])) { ?> checked="checked" <?php } ?>
                        ...
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="admin_login">Sign
                            in
                        </button>
