...
<div class="<?= $div_calss; ?> mb-1">
    <div class="message-label">
      <?php if(!empty($sender_image)){ ?>
        <img src="<?= $site_url; ?>/user_images/<?= $sender_image; ?>" class="rounded-circle mb-1" width="30">
      <?php }else{ ?>
      <img src="<?= $site_url; ?>/user_images/empty-image.png" class="rounded-circle mb-1" width="30">
      <?php } ?>
      <?= $sender_user_name; ?>
    </div>
