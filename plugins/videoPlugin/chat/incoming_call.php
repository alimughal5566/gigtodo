...
$image = escape($row_sender->seller_image);
...
<div id="video_chat_accept" class="modal fade" style="z-index: 7050;"><!-- video_chat_accept modal fade Starts -->
	...
	<div class="modal-content"><!-- modal-content Starts -->
		...
		<div class="modal-body"><!-- modal-body Starts -->
			<img src="user_images/<?= $image; ?>" class='float-left img-fluid rounded-circle' width="45">
			...
			<div class='group-body ml-1'>
				...
				<button id="accept-call-button" class="btn btn-small btn-success float-right ml-3 mt-3"> Accept </button>
				<button id="decline-call" class="btn btn-small btn-warning float-right mt-3"> Decline </button>
			</div>
		</div><!-- modal-body Ends -->
