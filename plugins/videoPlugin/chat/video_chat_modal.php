...
$image = escape($row_seller->seller_image);
if(empty($image)){
...
?>
<div id="video_chat_modal" class="modal fade" style="z-index: 2050;"><!-- video_chat_modal modal fade Starts -->
 <div class="modal-dialog modal-lg"><!-- modal-dialog Starts -->
    <div class="modal-content"><!-- modal-content Starts -->
     ...
     <div class="modal-body"><!-- modal-body Starts -->
        <h5 class="clearfix">
           <span class="float-left d-none d-lg-block"> Video Chat with <span class="text-success"><?= $name; ?></span></span>
        ...
        <div class="row mb-2 mt-3 justify-content-center"><!--- row mb-2 mt-3 Starts --->
					...
					<div id="subscriber" class="col-md-6 bg-dark"><!--- col-md-6 bg-dark Starts --->
					  ...
					  <div id="subscriber-ringing" class="w-100 h-100 text-center">
							<img src="user_images/<?= $image; ?>" class='img-fluid rounded-circle' width="140">
        ...
        <div class="text-center mt-3">
					...
					<button class="btn start-archive btn-success mb-2"><i class="fa fa-play"></i> Start Video Call Recording</button>
					<button class="btn stop-archive btn-danger mb-2"><i class="fa fa-pause"></i> Stop Video Call Recording</button>
					<button class="btn download-archive btn-success mb-2"><i class="fa fa-download"></i> Download Recored Video Call</button>
					<?php } ?>
					<?php if($seller_id == $login_seller_id){ ?>
					<button class="btn extend-time btn-success mb-2" disabled=""><i class="fa fa-clock-o"></i> Extend Time</button>
					<button class="btn extend-time-custom-amount btn-success mb-2" disabled=""><i class="fa fa-plus-circle"></i> Extend Time with Custom Amount</button>
					<?php } ?>
