...
<div id="videoSettings" class="<?= ($c_video==0)?"d-none":""; ?>">
  ...
  <div class="form-group row"><!--- form-group row Starts --->
    ...
    <div class="col-md-6">
      <input type="number" list="reminder_emails" name="reminder_emails" class="form-control" value="<?= $reminder_emails; ?>" min="1" placeholder="Select Minutes" <?= ($c_video==1)?"required":""; ?>>
  ...
  <div class="form-group row"><!--- form-group row Starts --->
    ...
    <div class="col-md-6">
      <input type="number" list="missed_session_emails" name="missed_session_emails" class="form-control" value="<?= $missed_session_emails; ?>" min="1" placeholder="Select Minutes" <?= ($c_video==1)?"required":""; ?>>
  ...
  <div class="form-group row"><!--- form-group row Starts --->
    ...
    <div class="col-md-6">
      <input type="number" list="warning_message" name="warning_message" class="form-control" value="<?= $warning_message; ?>" min="1" placeholder="Select Minutes" <?= ($c_video==1)?"required":""; ?>>
