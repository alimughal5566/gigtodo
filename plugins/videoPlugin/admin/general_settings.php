		...
		<div class="card mb-5"><!--- card mb-5 Starts --->
			...
			<div class="card-body"><!--- card-body Starts --->
			  <form method="post" enctype="multipart/form-data"><!--- form Starts --->
			    ...
			    <label class="col-md-3 control-label"> Opentok Api Key : </label>
			    <div class="col-md-6">
			    ...
			    <div class="form-group row"><!--- form-group row Starts --->
			    <label class="col-md-3 control-label"> Opentok Api Secret : </label>
			    <div class="col-md-6">
  ...
  if($val->run() == false){
    ...
    redirect("index?general_settings");
	  ...
	  if($update_general_settings){
	    ...
	    successRedirect("Video Chat Settings has been updated successfully","index?general_settings");
