 ...
 $('#payment-modal').on('shown.bs.modal', function(event){
  ...
  function deleteExtendTime(){
	...
	if(current_balance < amount){
		...
		if(enable_paypal == "yes"){
		...
		}else if(enable_paypal == "no" & enable_stripe == "no") {
 		...
 		}else if(enable_paypal == "no" & enable_stripe == "no" & enable_2checkout == "no" & enable_coinpayments == "yes") {
		
			$('#mobile-money-form').hide();
			$('#paystack-form').hide();
		
		}else if(enable_paypal == "no" & enable_stripe == "no" & enable_2checkout == "no" & enable_coinpayments == "no" & enable_paystack == "yes") {
